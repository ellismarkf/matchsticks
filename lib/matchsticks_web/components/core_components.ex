defmodule MatchsticksWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(MatchsticksWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(MatchsticksWeb.Gettext, "errors", msg, opts)
    # end
